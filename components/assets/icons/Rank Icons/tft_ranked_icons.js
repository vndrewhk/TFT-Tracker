const RANKED_ICONS = {
  tft_iron: require("./tft_regalia_iron.png").default,
  ...
  tft_challenger: require("./tft_regalia_challenger.png").default,
  tft_provisional: require("./tft_regalia_provisional.png").default,
};
export default RANKED_ICONS;
